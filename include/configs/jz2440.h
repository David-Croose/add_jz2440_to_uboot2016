...
#define CONFIG_SERVERIP		192.168.1.145
#define CONFIG_GATEWAYIP	192.168.1.1
#define CONFIG_JZ2440_ETHADDR		0xAA,0xBB,0xCC,0xDD,0xEE,0xFF
...
#define CONFIG_SYS_INIT_SP_ADDR	(CONFIG_SYS_SDRAM_BASE + 0x10000 - \
...
#define CONFIG_SPL_STACK 0x34000000
